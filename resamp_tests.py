...
"""
Test resampling methods, and the filters' effects on resampling
"""
...
plot_calc_spect(audio, fs, 'Original Waveform', False, 0)
...
plot_calc_spect(audio_ds, new_fs, 'Downsampled', False, 1)
torchaudio.save(TEST_FOLDER + "ds_audio.wav", audio_ds, new_fs)

kaiser_ds = filt_downsampler(audio)
plot_calc_spect(kaiser_ds, new_fs, 'Kaiser Downsampled', False, 2)
...
plot_calc_spect(butter_ds, new_fs, 'Butterworth Downsampled', False, 3)
...
plot_calc_spect(bessel_ds, new_fs, 'Bessel Downsampled', False, 4)
...
plot_calc_spect(cheby_ds, new_fs, 'Chebyshev Downsampled', False, 5)
...
plot_calc_spect(ellip_ds, new_fs, 'Elliptic Downsampled', False, 6)
